...
let currentDate= (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(), 'do MMM, yyyy');
 let todoOne= (0,_components_app__WEBPACK_IMPORTED_MODULE_0__.createTodo)('code1', 'write app logic', currentDate,'high', false);
console.table('checklist: '+ (0,_components_app__WEBPACK_IMPORTED_MODULE_0__.markComplete)(todoOne.checklist))

let checkbox = `<input type="checkbox" name="vehicle1" value="Bike">`;
